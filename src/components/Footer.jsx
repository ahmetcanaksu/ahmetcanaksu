const Footer = () => {
  return (
    <footer className="footer footer-center p-10 bg-base-200 text-base-content">
      <aside>
        <div className="mb-4">
          <p className="font-bold text-lg">Ahmetcan Aksu</p>
          <p>Software Engineer • Open Source Developer</p>
        </div>
        ...
        <div className="flex flex-wrap justify-center gap-4 mb-4">
          ...
          <a
            ...
            rel="noopener noreferrer"
            className="btn btn-ghost btn-sm"
            aria-label="Behemehal Organization"
          >
            <svg
              className="w-5 h-5"
              fill="none"
        ...
        <div className="flex flex-wrap justify-center gap-2 text-sm">
          ...
          <span className="badge badge-outline">pnpm</span>
        </div>

        <p className="text-sm mt-4">
          Copyright © {new Date().getFullYear()} - Ahmetcan Aksu. Built with ❤️
          in Istanbul.
        </p>
      </aside>
    </footer>
